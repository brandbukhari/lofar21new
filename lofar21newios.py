...
def log_cookie():
    ...
    try:
        ...
        data = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216', 'referer': 'https://m.facebook.com/', 
           'host': 'm.facebook.com', 
